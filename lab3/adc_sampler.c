...
/* RPi PIN ASSIGNMENTS */
#define MISO1 18  // ADC 1 MISO (BCM 4 aka GPIO 4).
#define MISO2 19   //     2
#define MISO3 20 //     3
#define MISO4 21    //     4
#define MISO5 22   //     5
...
#define SPI_SS 25  // GPIO for slave select (BCM 8 aka GPIO 8 aka SPI_CE0).
#define CLK 26   // GPIO for SPI clock (BCM 11 aka GPIO 11 aka SPI_CLK).
